...
return function()
	...
	describe("Item's ref", function()
		it("should be accepted and assigned", function()
			local ref = Roact.createRef()
			local mergedProps = Cryo.Dictionary.join(defaultTestProperties, {
				[Roact.Ref] = ref,
			})
			...
			local element = Roact.createElement("Frame", {
				...
				Roact.createElement(DefaultMetricsGridView, mergedProps),
				}
			)
