...
local StringTrim = require(Modules.Common.StringUtilities.StringTrim)
local StringSplit = require(Modules.Common.StringUtilities.StringSplit)
local encodeURIComponent = require(Modules.NotLApp.Http.encodeURIComponent)
local UrlBase = require(Modules.NotLApp.Http.UrlBase)

local GameUrlPatterns = require(Modules.NotLApp.Http.UrlPatterns.GameUrlPatterns)
local UserUrlPatterns = require(Modules.NotLApp.Http.UrlPatterns.UserUrlPatterns)
local StaticUrlPatterns = require(Modules.NotLApp.Http.UrlPatterns.StaticUrlPatterns)
